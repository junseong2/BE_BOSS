...
//    Page<Product> findByCategoryIdIn(@Param("categoryIds") List<Long> categoryIds, Pageable pageable);
    ...
    @Query("""
    	    SELECT new com.onshop.shop.domain.product.dto.ProductsDTO(
    	        p.productId,
    	        p.category.id,
    	        p.seller.sellerId,
    	        p.name,
    	...
    	""")
    	Page<ProductsDTO> findByCategoryIdIn(@Param("categoryIds") List<Long> categoryIds, Pageable pageable);
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<SellerProductsDTO> findBySellerAndSearchOrderByPriceDesc(
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<SellerProductsDTO> findBySellerAndSearchOrderByCreatedDateDesc(
			@Param("sellerId") Long sellerId,
			@Param("search") String search, Pageable pageable);
	...
	@Query(value = """
			...
			""", nativeQuery = true)
	Page<SellerProductsDTO> findBySellerAndSearchOrderBySalesDesc(
			@Param("sellerId") Long sellerId,
			@Param("search") String search, Pageable pageable);
    ...
    @Query(value = """
    	    ...
    	    ORDER BY p.price ASC
    	""", nativeQuery = true)
    	Page<SellerProductsListDTO> findSellerProductsByPriceAsc(
    			@Param("sellerId") Long sellerId,
    	        @Param("search") String search, Pageable pageable);
    ...
    @Query(value = """
    	    ...
    	    ORDER BY p.price DESC
    	""", nativeQuery = true)
    	Page<SellerProductsListDTO> findSellerProductsByPriceDesc(
    			@Param("sellerId") Long sellerId,
    	        @Param("search") String search, Pageable pageable
    	        );
    ...
    @Query(value = """
    	    ...
    	    ORDER BY p.created_register DESC
    	""", nativeQuery = true)
    	Page<SellerProductsListDTO> findSellerProductsByCreatedDateDesc(
    			@Param("sellerId") Long sellerId,
    	        @Param("search") String search, Pageable pageable
    	        );
    ...
    @Query(value = """
    	    ...
    	    ORDER BY p.overall_sales DESC
    	""", nativeQuery = true)
    	Page<SellerProductsListDTO> findSellerProductsBySalesDesc(
    			@Param("sellerId") Long sellerId,
    	        @Param("search") String search, Pageable pageable
    	        );
    ...
    @Query(value = """
        ...
        ORDER BY p.price DESC
    """, nativeQuery = true)
    Page<SellerProductsListDTO> findSellerProductsByCategoryAndPriceDesc(
    		@Param("sellerId") Long sellerId,
    		@Param("categoryId") Long categoryId,
    ...
    @Query(value = """
        ...
        ORDER BY p.price ASC
    """, nativeQuery = true)
    Page<SellerProductsListDTO> findSellerProductsByCategoryAndPriceAsc(  
    		@Param("sellerId") Long sellerId,
    		@Param("categoryId") Long categoryId,
    		@Param("search") String search,
    		Pageable pageable);
    ...
    @Query(value = """
        ...
        ORDER BY p.created_register DESC
    """, nativeQuery = true)
    Page<SellerProductsListDTO> findSellerProductsByCategoryAndCreatedDateDesc(
    		@Param("sellerId") Long sellerId,
    		@Param("categoryId") Long categoryId,
    		@Param("search") String search,
    		Pageable pageable);
