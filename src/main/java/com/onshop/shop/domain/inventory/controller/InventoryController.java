package com.onshop.shop.domain.inventory.controller;
...
import com.onshop.shop.domain.inventory.service.InventoryService;
...
public class InventoryController {
	...
	public ResponseEntity<SellerInventoryResponseDTO> getAllInventory(
			...
			@RequestParam("state")  @Pattern(regexp = "soldout|warn|all", message = "'soldout', 'warn', 'all' 중 하나이어야 합니다.")  String state,
